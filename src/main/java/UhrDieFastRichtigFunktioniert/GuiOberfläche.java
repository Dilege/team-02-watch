...
public class GuiOberfl�che extends Uhrzeit {
	
	private  JFrame frame;
	
	public GuiOberfl�che()  {
		createFrame();
	}
...
private void createFrame()   { //Fenster erzeugen
		...
		button2.addActionListener(actionEvent-> button2.setText("Schlie�en"));		
	...
	private  void createMenuBar() {
		...
		JMenuItem beendenItem= new JMenuItem("Beenden");
		 ...
		 JMenuItem uberItem=new JMenuItem("�ber");
		 ...
		 JMenuItem gr��e=new JMenuItem("Schriftgr��e");
		 einstellungenMenu.add(gr��e);
